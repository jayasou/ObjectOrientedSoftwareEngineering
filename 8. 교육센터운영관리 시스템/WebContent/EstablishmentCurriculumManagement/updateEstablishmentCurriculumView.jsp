...
%>
<body>
	<form method="post" onsubmit="return on_submit();" action="updateEstablishmentCurriculum.jsp" id="su">
	<div align="center">
		...
		<div style="display: none">
			...
			<table width="800px">
				<tr>
					<td>개설 과정 명</td>
					<td colspan="4"><input type="text" name="curriculumName" size="75" value="<%=establishment_curriculum_info.getCurriculumName()%>"></td>
				<tr>
					<td style="text-align: right;">개설강의</td>
					<td><select style="width: 100%" id="lecture_name" name="lecture_name">
							<%							
					...
					<td><input type="button" name="add_curriculum" value="추가하기" onclick="add_row()"></td>
				</tr>
			</table>
			<fieldset>
