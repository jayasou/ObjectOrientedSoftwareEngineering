...
<%
	...
	String establishment_curriculum_num = request.getParameter("index2");
	...
	establishmentCurriculumManagement.updateEstablishmentCurriculum(establishmentCurriculumInfo, establishment_curriculum_num);
%>
