...
<body>
	<form action="" id ="su">
		...
		<br>
		<div align="center">
			<input type="button" value="등록" class="button" onclick="javascript:location.href='regManagementSubjectView.jsp'">
			<input type="button" value="수정" class="button" onclick="go('updateManagementSubjectView.jsp')">
			<input type="button" value="삭제" class="button" onclick="go('delManagementSubjectView.jsp')">
